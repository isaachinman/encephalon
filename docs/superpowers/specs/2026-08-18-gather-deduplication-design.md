...
The exact implementation and behavioural-test snapshot is `45cd8e649781151fb359bdc82343a12a11c50597`. Documentation does not change the public API, package exports, cache schema, canonical records, or operation budgets.
