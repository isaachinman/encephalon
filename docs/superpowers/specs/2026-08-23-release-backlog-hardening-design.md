...
The exact reviewed repository-controlled MAR-2574 code and behavioural-test snapshot is `006c3101a00b6c27d2191cd7acdcefca69d23270`. Its final remediation lineage is `f0f625bfdf43ba69925087b53b93d913c67403bf` for reusable-caller credential semantics, `8dd6d14fe43731276f8f34293adbcec19bc3f7da` for role-keyed traversal and final source-witness revalidation, and `006c3101a00b6c27d2191cd7acdcefca69d23270` for external caller authority, the accurate external-reference taxonomy, and actionable diagnostics. At the final snapshot the focused workflow policy passed 31 tests with one Windows-only skip and no failures; lint checked 117 files, all four TypeScript projects passed, the full suite passed 562 of 564 tests with two established skips and no failures, and both the policy CLI and 38-record Encephalon validation were clean. These repository-policy changes preserve the Node runtime API, package exports, canonical data, cache schema, and generated declarations.
