...
- [ ] **Step 3: Implement the immutable limits and contained ledger**
...
- [ ] **Step 4: Run the pure test and static checks**
...
- [ ] **Step 1: Write the focused behavioural tests**
...
- [ ] **Step 3: Centralise the existing full-record ledger**
...
- [ ] **Step 4: Implement compact streaming**
...
- [ ] **Step 5: Implement the gather ledger**
...
- [ ] **Step 6: Run focused, cache, and mutation checks**
...
- [ ] **Step 2: Write the documentation provenance RED**
